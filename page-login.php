...
@include_once( APP_SERVER_DIR . '/inc/app.init.php');
...
<html lang="en">
<head>
	<?php include_once( APP_SERVER_DIR . 'inc/part.head.php' ); ?>
</head>
<body role="document">
<?php include_once( APP_SERVER_DIR . 'inc/part.header-nav.php' ); ?>
<div class="container">
	...
	<?php endif; ?>
	<form class="form-signin" method="post" action="?reauth=login">
		<h2 class="form-signin-heading">Please sign in</h2>
		<label for="inputPassword" class="sr-only">Invite Code</label>
		<input type="password" id="<?php echo $auth_cookie_name; ?>" name="<?php echo $auth_cookie_name; ?>"
			   class="form-control" placeholder="passkey" required>
